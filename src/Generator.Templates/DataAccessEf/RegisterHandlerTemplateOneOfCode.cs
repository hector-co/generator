...
{
    public partial class RegisterHandlerTemplateOneOf
    {
        private readonly ModuleDefinition _module;
        private readonly ModelDefinition _model;

        public RegisterHandlerTemplateOneOf(ModuleDefinition moduleDefinition, ModelDefinition modelDefinition)
        {
