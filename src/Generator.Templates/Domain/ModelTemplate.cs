...
#line hidden
  ...
  if (_model.IsEntity && _module.DomainSettings.EntityUsings.Any()) 
      ...
      foreach (var @using in _module.DomainSettings.EntityUsings) 
        { 
            ...
            #line 17 "D:\Hector\Documents\code\generatorv2\src\Generator.Templates\Domain\ModelTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(_model.GetBaseClassName(_module)));
  ...
  foreach(var property in _model.Properties.Values)
    {   
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(_model.GetPropertyTypeName(property)));
            ...
            #line 25 "D:\Hector\Documents\code\generatorv2\src\Generator.Templates\Domain\ModelTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(_model.GetPropertyName(property)));
